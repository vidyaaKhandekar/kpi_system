import { AppBar, styled, Toolbar, Typography,Avatar,Menu,MenuItem} from "@mui/material";
...
const Navbar =()=>{
    ...
    return(
        <AppBar bgcolor="#987D9A" position="sticky" sx={
            {
                bgcolor:"white",
                height:{
                    xs:"75px",
            ...
            <StyleToolbar>
                <Typography variant="h6" alignContent="centre" sx={{
                    display:{
                        xs:"none",
                        sm:"block"
                    },
                ...
                <Person>
                    ...
                    <Avatar onClick={e=>setOpen(true)}  sx={{ bgcolor:"#478CCF" }}><PersonIcon/>
                    </Avatar>
